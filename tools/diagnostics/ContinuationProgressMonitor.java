...
public class ContinuationProgressMonitor {
    ...
    static void requireSupportedPlan(JsonObject plan) {
        var superiority = plan.get("seekSuperiority");
        check(superiority == null || superiority instanceof JsonPrimitive value && value.getContent().equals("false"),
                "This monitor supports default continuation only; seekSuperiority requires its own confidence-sequence readout");
    }
    ...
    static class Monitor {
        ...
        Monitor(Path setup) throws Exception {
            ...
            requireSupportedPlan(object(setup.resolve("continuation-plan.json")));
