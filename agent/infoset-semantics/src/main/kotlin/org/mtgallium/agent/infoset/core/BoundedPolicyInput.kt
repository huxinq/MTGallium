 ...
 *
 * The authoritative safe ledger remains in [InformationStateRepresentation] and durable per-game storage.
...
data class BoundedPolicyInput(
    ...
    fun toInformationState(ledger: List<PolicyHistoryEvent>): InformationStateRepresentation {
        requireValidDigest()
