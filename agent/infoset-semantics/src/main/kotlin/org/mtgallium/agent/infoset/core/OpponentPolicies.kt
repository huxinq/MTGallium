...
class MixtureOpponentPolicy(
    ...
    override fun distribution(context: DecisionSiteRequest, policySeed: Long): ProbabilityDistribution<SemanticChoice> {
        ...
        for ((componentIndex, component) in components.withIndex()) {
            ...
            val distribution = component.policy.distribution(context,
    ...
    override fun decisionDiagnostic(context: DecisionSiteRequest, chosen: SemanticChoice, policySeed: Long,
        ...
        val contributions = components.mapIndexed { componentIndex, component ->
            ...
            val probability = if (component.weight == 0.0) 0.0 else {
                component.policy.distribution(context, componentSeed).probabilityOf { it.signature == chosen.signature }
            }
        ...
        val nested = selected.policy.decisionDiagnostic(
            context = context, chosen = chosen, policySeed = selectedPolicySeed,
