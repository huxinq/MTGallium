...
@Serializable
@SerialName("org.mtgallium.agent.searchteacher.TacticalFeatureFamily")
...
@Serializable
@SerialName("org.mtgallium.agent.searchteacher.MonoRedTacticalEvaluatorWeights")
...
@Serializable
@SerialName("org.mtgallium.agent.searchteacher.MonoRedTacticalEvaluatorSettings")
...
@Serializable
@SerialName("org.mtgallium.agent.searchteacher.TacticalEvaluationResult")
 ...
 *
 * It deliberately consumes only the already projected [InformationStateRepresentation]. Root-private
...
class MonoRedTacticalEvaluator(
    ...
    private fun attackWindowRemains(observation: PlayerObservationSnapshot): Boolean {
    ...
    private fun initiative(player: String, observation: PlayerObservationSnapshot): Double {
        var value = 0.0
...
@Serializable
@SerialName("org.mtgallium.agent.searchteacher.MonoRedTacticalLinearFeatures")
