...
@Serializable
@SerialName("org.mtgallium.agent.searchteacher.MonoRedVisibleEvaluatorConfig")
...
@Serializable
@SerialName("org.mtgallium.agent.searchteacher.MonoRedVisiblePermanentFeatures")
 ...
 */
@Serializable
@SerialName("org.mtgallium.agent.searchteacher.MonoRedVisibleFeatures")
data class MonoRedVisibleFeatures(
    ...
    companion object {
        fun extract(information: InformationStateRepresentation, rootPlayer: String): MonoRedVisibleFeatures {
