...
@Serializable
enum class TacticalSchema2FeatureFamily {
    NONLINEAR_LIFE,
    COMBAT_READINESS,
    REACH,
    HAND_VALUE,
...
@Serializable
data class MonoRedTacticalEvaluatorSchema2Weights(
...
@Serializable
data class MonoRedTacticalEvaluatorSchema2Settings(
    val schemaVersion: Int = 2,
    val outputTemperature: Double = 2.0,
    val startingLife: Int = 20,
    val annotationVersion: String = "mono-red-tactical-annotations-v2",
    val enabledFamilies: Set<TacticalSchema2FeatureFamily> = TacticalSchema2FeatureFamily.entries.toSet(),
    val weights: MonoRedTacticalEvaluatorSchema2Weights = MonoRedTacticalEvaluatorSchema2Weights(),
) {
    init {
    ...
    val configurationId: String
        get() = listOf(
            MonoRedTacticalEvaluatorSchema2.EVALUATOR_ID,
            "schema-$schemaVersion",
            "temperature-${canonicalTacticalNumber(outputTemperature)}",
            "life-$startingLife",
            annotationVersion,
            enabledFamilies.sortedBy(TacticalSchema2FeatureFamily::name).joinToString("+") { it.name },
...
@Serializable
data class TacticalSchema2EvaluationResult(
 ...
 */
class MonoRedTacticalEvaluatorSchema2(
    val settings: MonoRedTacticalEvaluatorSchema2Settings = MonoRedTacticalEvaluatorSchema2Settings(),
    ...
    fun evaluateDetailed(
        ...
        rootPlayer: String,
    ): TacticalSchema2EvaluationResult {
        ...
        components["phiLethal"] = enabled(
            TacticalSchema2FeatureFamily.REACH,
        ...
        components["phiHand"] = enabled(
            TacticalSchema2FeatureFamily.HAND_VALUE,
        ...
        components["phiDurableMana"] = enabled(
            TacticalSchema2FeatureFamily.DURABLE_MANA,
            normalizedDifference(
        ...
        components["phiInitiative"] = enabled(
            TacticalSchema2FeatureFamily.INITIATIVE,
        ...
        return TacticalSchema2EvaluationResult(
            evaluatorId = id,
...
object MonoRedTacticalEvaluatorSchema2V3 : ConfiguredInformationStateEvaluator by MonoRedTacticalEvaluatorSchema2()
